...
| `BOCHA_API_KEYS` | [博查搜索](https://open.bocha.cn/) Web Search API（中文搜索优化，支持AI摘要，多个key用逗号分隔） | 推荐 |
...
SERPAPI_API_KEYS=your_serpapi_key       # SerpAPI备用搜索
```
